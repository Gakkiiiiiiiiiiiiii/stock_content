...
class StaleTaskLease(RuntimeError):
    """The caller no longer owns an unexpired content-task lease."""


class IdempotencyConflict(RuntimeError):
    """A client reused a key for a different canonical request."""
...
class ClaimRepository(Protocol):
    ...
    def formal_bundle_eligible_claim_ids(self, claim_ids: list[str] | None = None) -> list[str]: ...
